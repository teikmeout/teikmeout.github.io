...
function Footer() {
  return (
    <footer className="footer">
      ...
      <div className="contact-info"><span aria-label="avo" role="img">🍥</span> <a className="bottom-link" href="https://github.com/teikmeout/resume/raw/master/JonathanAhrensCV.pdf">Resume Download</a></div>
      <br/>
